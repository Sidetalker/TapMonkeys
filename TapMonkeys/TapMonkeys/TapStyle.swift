...
//  TapMonkeys
//
//  Created by Kevin Sullivan on 5/16/15.
...
public class TapStyle : NSObject {
    ...
    public class func drawUnknownUnlock() {
        ...
        let ovalFontAttributes = [NSFontAttributeName: UIFont(name: "Noteworthy-Bold", size: 64)!, NSForegroundColorAttributeName: UIColor.blackColor(), NSParagraphStyleAttributeName: ovalStyle]
        ...
        let ovalTextRect: CGRect = CGRectMake(ovalRect.minX, ovalRect.minY + (ovalRect.height - ovalTextHeight) / 2, ovalRect.width, ovalTextHeight)
        CGContextSaveGState(context)
        CGContextClipToRect(context, ovalRect);
        ovalTextContent.drawInRect(ovalTextRect, withAttributes: ovalFontAttributes)
        CGContextRestoreGState(context)
        
        ////// Oval Text Inner Shadow
        CGContextSaveGState(context)
        CGContextClipToRect(context, ovalRect)
        CGContextSetShadow(context, CGSizeMake(0, 0), 0)
        CGContextSetAlpha(context, CGColorGetAlpha((TapStyle.picShadow.shadowColor as! UIColor).CGColor))
        CGContextBeginTransparencyLayer(context, nil)
        let ovalOpaqueTextShadow = (TapStyle.picShadow.shadowColor as! UIColor).colorWithAlphaComponent(1)
        CGContextSetShadowWithColor(context, TapStyle.picShadow.shadowOffset, TapStyle.picShadow.shadowBlurRadius, ovalOpaqueTextShadow.CGColor)
        CGContextSetBlendMode(context, kCGBlendModeSourceOut)
        CGContextBeginTransparencyLayer(context, nil)

        ovalOpaqueTextShadow.setFill()

        let ovalInnerShadowFontAttributes = [NSFontAttributeName: UIFont(name: "Noteworthy-Bold", size: 64)!, NSForegroundColorAttributeName: (TapStyle.picShadow.shadowColor as! UIColor), NSParagraphStyleAttributeName: ovalStyle]
        ovalTextContent.drawInRect(ovalTextRect, withAttributes: ovalInnerShadowFontAttributes)
